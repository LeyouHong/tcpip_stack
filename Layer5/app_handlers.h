...
int ddcp_config_cli_tree(param_t *param);

int ddcp_show_cli_tree(param_t *param);

int ddcp_run_cli_tree(param_t *param);

int nmp_config_cli_tree(param_t *param);

int nmp_show_cli_tree(param_t *param);
