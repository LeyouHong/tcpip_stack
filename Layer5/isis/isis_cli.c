...
static int isis_show_handler(param_t *param, ser_buff_t *tlv_buf, op_mode enable_or_disable) {
  printf("%s called\n", __FUNCTION__);
...
static int isis_intf_config_handler(param_t *param, ser_buff_t *tlv_buf, op_mode enable_or_disable) {
  printf("%s called\n", __FUNCTION__);
